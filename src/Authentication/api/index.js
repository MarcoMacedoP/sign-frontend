...
export const authApi = {
  ...
  // 	const base64encodedData = Buffer.from(user + ':' + password).toString(
  // 		'base64'
  // 	);
  // 	const options = {
  // 		method: 'POST',
  ...
  // 		return true;
  // 	} catch (error) {
  // 		throw new Error('Contraseña erronea o usario inexistente 🤷🏽‍♂️ ');
  // 	}
  // },
  async signup({name, lastname, email, password}) {
    // const options = {
    //   method: "POST",
    //   body: JSON.stringify({name, lastname, email, password, type: 1}) //TODO fix this
    // };
    // try {
