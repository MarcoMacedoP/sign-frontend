...
export const fetchProviders:ThunkAction<void,GlobalState, null, Action<string>> = 
() => (dispatch:Dispatch) => {
...
export const fetchAddProvider:ThunkAction<void,GlobalState, null, Action<string>> =
...
export const fetchAddIncome:ThunkAction<void,GlobalState, null, Action<string>>=
(income, providerId) => (dispatch:Dispatch) => {
    ...
    return callApi("/expenses/", {
      ...
      .then(() => dispatch(addIncome("success")))
